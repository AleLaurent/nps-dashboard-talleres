...
# ==========================================
# CONFIGURACIÓN DE IDENTIDAD VISUAL (CSS MEJORADO)
# ==========================================
...
st.markdown(f"""
    ...
    /* Tarjetas de KPIs - Mejor contraste */
    ...
    /* VALOR DEL KPI - Azul vibrante y fuerte */
    ...
    /* ETIQUETA DEL KPI - Cambiado de gris claro a gris muy oscuro para legibilidad */
...
def load_and_process_data():
    try:
        ...
        for col in skill_cols:
            if col in df_raw.columns:
                df_raw[col] = df_//raw[col].astype(str).str.replace('%', '').astype(float)
...
# ... (el resto de las pestañas siguen la misma lógica de colores)
# He omitido el resto por espacio, pero aplica los mismos cambios de color en plotly:
# font=dict(color=TEXT_DARK), title_font=dict(color=TEXT_DARK)
