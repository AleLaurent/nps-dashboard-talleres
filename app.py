...
# ==========================================
# 1. CONFIGURACIÓN DE IDENTIDAD VISUAL (CSS LIMPIO)
# ==========================================
st.set_page_config(layout="wide", page_title="NPS Executive Dashboard")

st.markdown(f"""
    <style>
    /* Fondo global blanco puro para evitar superposiciones */
    .stApp {{
    ...
    /* Títulos con contraste máximo */
    h1, h2, h3 {{
        color: #111827 !important;
        font-weight: 800 !important;
    }}

    /* TARJETAS DE KPIs - Diseño limpio, sin fondos que tapen texto */
    ...
    /* Valor del KPI: Azul vibrante pero SIN fondo */
    ...
    /* Etiqueta del KPI: Gris oscuro, legible, sin fondo */
    ...
    /* Contenedores de Gráficos - Bordes definidos y fondo blanco */
    .stPlotlyChart {{
        background-color: #FFFFFF !important;
        border: 1px solid #E5E7EB !important;
        border-radius: 16px !important;
    ...
    /* Tabs - Eliminamos fondos extraños, solo borde inferior */
    ...
    /* Forzar que todas las tablas tengan texto negro y fondo blanco */
    .stDataFrame {{
        background-color: #FFFFFF !important;
    }}
    </style>
...
# ==========================================
# 4. INTERFAZ DE USUARIO (Súper Limpia)
# ==========================================
st.title("🚀 Monitoreo de Experiencia NPS")
st.markdown(f"<p style='color: #374151; font-size: 1.1rem;'>Análisis de calidad de talleres y desempeño de speakers</p>", unsafe_allow_html=True)
...
with tabs[1]:
    if df_f.empty:
        ...
        # Dataframe limpio sin estilos conflictivos
...
with tabs[4]:
    if df_f.empty:
        ...
        if total_coment > 0:
            ...
            # Tabla simple sin estilos que puedan tapar el texto
...
st.markdown("<p style='text-align: center; color: #6B7280;'>Dashboard de Monitoreo de Calidad | Identidad Visual v3.0 (Ultra Contrast)</p>", unsafe_allow_html=True)
